# Browser Board Game Engine (BBGE) — Vision

Platform identity, philosophy, subsystem catalog, and long-term vision.

For technical modules / data flow / sync / lifecycle see [architecture.md](architecture.md).  
For plugin contracts and developer handbook see [plugin-api.md](plugin-api.md).  
For agent workflow see [SKILL.md](SKILL.md).
