...
A curated, bilingual reference website for modern board game rules — **60** games (including expansions/variants), interactive decision trees, trainers, **BBGE online play**, LLM-powered Q&A, deployed as a pure static site to GitHub Pages.

## Features

- **60 game rules**: web-verified, complete bilingual rules (EN/ZH)
- **60 interactive decision trees**: step-by-step flow with sidebar outline navigation
