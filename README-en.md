...
A curated, bilingual reference website for modern board game rules — **62** games (including expansions/variants), interactive decision trees, trainers, **BBGE online play**, LLM-powered Q&A, deployed as a pure static site to GitHub Pages.

## Features

- **62 game rules**: web-verified, complete bilingual rules (EN/ZH)
- **62 interactive decision trees**: step-by-step flow with sidebar outline navigation
