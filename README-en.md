...
A curated, bilingual reference website for modern board game rules — **68** games (including expansions/variants), interactive decision trees, trainers, **BBGE online play**, LLM-powered Q&A, deployed as a pure static site to GitHub Pages.

## Features

- **68 game rules**: web-verified, complete bilingual rules (EN/ZH)
- **68 interactive decision trees**: step-by-step flow with sidebar outline navigation
...
├── features/                     # Feature UI (catalog / rules / flow / score / trainer / calculator / play / chat / costs)
