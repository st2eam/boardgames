...
A curated, bilingual reference website for modern board game rules — **74** games (including expansions/variants), interactive decision trees, trainers, **BBGE online play**, LLM-powered Q&A, deployed as a pure static site to GitHub Pages.

## Features

- **74 game rules**: web-verified, complete bilingual rules (EN/ZH)
- **74 interactive decision trees**: step-by-step flow with sidebar outline navigation
