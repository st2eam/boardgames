...
A curated, bilingual reference website for modern board game rules — **63** games (including expansions/variants), interactive decision trees, trainers, **BBGE online play**, LLM-powered Q&A, deployed as a pure static site to GitHub Pages.

## Features

- **63 game rules**: web-verified, complete bilingual rules (EN/ZH)
- **63 interactive decision trees**: step-by-step flow with sidebar outline navigation
