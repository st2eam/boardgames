...
**14 unique districts:** Dragon Gate, Factory, Haunted Quarter, Imperial Treasury, Keep, Laboratory, Library, Map Room, Quarry, School of Magic, Smithy, Statue, Thieves’ Den, Wishing Well.

1. Place matching **character tokens** in rank order in the center.
2. Shuffle the 14 unique districts with the 54 basic districts. Deal **4** cards facedown to each player.
3. Remaining districts form a facedown deck; gold forms the bank.
4. Each player takes **2 gold**.
...
1. **Gather resources** (mandatory): take **2 gold**, **or** draw **2** district cards, keep **1**, put the other on the **bottom** of the deck.
2. **Build** (optional): pay a district’s cost and play it into your city. Default limit **1** district. You cannot build a district **identical by name** to one already in your city (unless a card says otherwise).
...
- **+3** if you have at least one of **each** of the five types
- **+4** for the **first** player who completed a city
- **+2** for any **other** completed city
...
| District | Effect |
|----------|--------|
| **Dragon Gate** | +2 points at game end. |
| **Factory** | Other unique districts cost you **1 less**. |
| **Haunted Quarter** | At game end, count as **any one** type; if not unique, it no longer counts as unique. |
| **Imperial Treasury** | +1 point per gold in your **stash** at game end. |
| **Keep** | Rank 8 cannot use its ability on the Keep. |
| **Laboratory** | Once per turn: discard 1 card → **2 gold**. |
| **Library** | When gathering cards, **keep all** drawn. |
| **Map Room** | +1 point per card in **hand** at game end. |
| **Quarry** | You may build **identical** districts (cannot *acquire* copies via Magistrate / Diplomat / Marshal). |
| **School of Magic** | For character income, counts as **any type** you choose (Abbot: one resource of that type). |
| **Smithy** | Once per turn: pay **2 gold** → gain **3 cards**. |
| **Statue** | If you have the **crown** at game end, +5 points. |
| **Thieves’ Den** | You may pay part of its cost with cards (1 card = 1 gold). Magistrate refunds **gold only**. |
