...
2. **Ware accomplices** — only if their punt reached Manila; split the profit printed on the ware load equally.
3. **Port accomplices** — paid by the cash box if a punt landed on their space.
4. **Shipyard accomplices** — paid by the **insurance agent** (or cash box if none) if a punt landed on their space.
